...
ARESTAS = [
    # ── Norte ─────────────────────────────────────────────────────────────────
    ("Roraima",            "Amazonas",             650,  "BR-174"),
    ("Roraima",            "Pará",                 970,  "BR-210/174"),
    ("Roraima",            "Amapá",               1380,  "BR-156/174"),
    ("Amapá",              "Pará",                 590,  "BR-156/010"),
    ("Pará",               "Amazonas",             780,  "BR-230"),
    ("Pará",               "Maranhão",             870,  "BR-010/316"),
    ("Pará",               "Mato Grosso",          950,  "BR-163"),
    ("Pará",               "Tocantins",            620,  "BR-153/226"),
    ("Amazonas",           "Acre",                 700,  "BR-317"),
    ("Amazonas",           "Rondônia",             750,  "BR-319/364"),
    ("Amazonas",           "Mato Grosso",          980,  "BR-230/163"),
    ("Acre",               "Rondônia",             540,  "BR-364"),

    # ── Centro-Oeste ───────────────────────────────────────────────────────────
    ("Rondônia",           "Mato Grosso",          870,  "BR-364"),
    ("Mato Grosso",        "Tocantins",            580,  "BR-158"),
    ("Mato Grosso",        "Goiás",                380,  "BR-158/070"),
    ("Mato Grosso",        "Mato Grosso do Sul",   520,  "BR-163"),
    ("Goiás",              "Tocantins",            390,  "BR-153"),
    ("Goiás",              "Bahia",                620,  "BR-020/242"),
    ("Goiás",              "Minas Gerais",         310,  "BR-050/040"),
    ("Goiás",              "Mato Grosso do Sul",   600,  "BR-060"),
    ("Goiás",              "São Paulo",            420,  "BR-153/050"),
    ("Goiás",              "Distrito Federal",      95,  "BR-060/040"),
    ("Distrito Federal",   "Minas Gerais",         550,  "BR-040"),
    ("Mato Grosso do Sul", "Minas Gerais",         850,  "BR-262"),
    ("Mato Grosso do Sul", "São Paulo",            510,  "BR-262/060"),
    ("Mato Grosso do Sul", "Paraná",               680,  "BR-163/277"),

    # ── Nordeste ───────────────────────────────────────────────────────────────
    ("Maranhão",           "Piauí",                450,  "BR-316/135"),
    ("Maranhão",           "Tocantins",            820,  "BR-010/226"),
    ("Maranhão",           "Ceará",                620,  "BR-222"),
    ("Piauí",              "Ceará",                490,  "BR-020/316"),
    ("Piauí",              "Pernambuco",           560,  "BR-316/232"),
    ("Piauí",              "Bahia",                580,  "BR-135/020"),
    ("Piauí",              "Tocantins",            750,  "BR-226/010"),
    ("Ceará",              "Rio Grande do Norte",  290,  "BR-304"),
    ("Ceará",              "Paraíba",              430,  "BR-230/116"),
    ("Ceará",              "Pernambuco",           590,  "BR-116/232"),
    ("Rio Grande do Norte","Paraíba",              180,  "BR-101/226"),
    ("Rio Grande do Norte","Pernambuco",           290,  "BR-101/232"),
    ("Paraíba",            "Pernambuco",           230,  "BR-230/101"),
    ("Pernambuco",         "Alagoas",              280,  "BR-101/424"),
    ("Pernambuco",         "Bahia",                500,  "BR-116/428"),
    ("Pernambuco",         "Sergipe",              390,  "BR-101/235"),
    ("Alagoas",            "Sergipe",              100,  "BR-101"),
    ("Alagoas",            "Bahia",                370,  "BR-101/110"),
    ("Sergipe",            "Bahia",                330,  "BR-101/116"),

    # ── Sudeste ────────────────────────────────────────────────────────────────
    ("Bahia",              "Minas Gerais",         620,  "BR-116/251"),
    ("Bahia",              "Espírito Santo",       640,  "BR-101/262"),
    ("Bahia",              "Tocantins",            480,  "BR-242/020"),
    ("Minas Gerais",       "Espírito Santo",       340,  "BR-262/101"),
    ("Minas Gerais",       "Rio de Janeiro",       450,  "BR-040/116"),
    ("Minas Gerais",       "São Paulo",            550,  "BR-381/116"),
    ("Rio de Janeiro",     "Espírito Santo",       520,  "BR-101"),
    ("Rio de Janeiro",     "São Paulo",            430,  "BR-116/101"),
    ("São Paulo",          "Paraná",               410,  "BR-376/116"),

    # ── Sul ────────────────────────────────────────────────────────────────────
    ("Paraná",             "Santa Catarina",       350,  "BR-116/376"),
    ("Santa Catarina",     "Rio Grande do Sul",    300,  "BR-116/101"),
]
...
C = {
    ...
    # Mapa — tons de verde escuro sobre fundo neutro
    "map_bg":        (15,  20,  32),
    "state_fill":    (28,  52,  36),      # verde floresta escuro
    "state_alt":     (24,  46,  32),      # variação sutil
    "state_border":  (55,  95,  65),      # borda verde médio
    "state_hover":   (38,  72,  52),      # hover levemente mais claro
    "state_path":    (30,  64,  80),      # azul-verde para rota
    "state_orig":    (25,  75,  55),
    "state_dest":    (80,  30,  45),
    # Arestas
    "edge":          (50,  70, 100),
...
# ─────────────────────────────────────────────
#  PROJEÇÃO WEB MERCATOR (mesma dos tiles OSM)
# ─────────────────────────────────────────────
...
_MY0 = _merc(LAT_MAX)   # norte
_MY1 = _merc(LAT_MIN)   # sul
...
class TurisGraphApp:
    ...
    MAP_W   = W - PANEL_W
    MAP_H   = H
    PAD     = 28   # padding interno do mapa
    ...
    def __init__(self):
        ...
        self.estados_list = sorted(self.grafo.adjacencia.keys())
        ...
        self.hover_edge      = None   # (de, para, km, rod) da aresta sob o cursor
        self.clicked_edge    = None   # aresta fixada pelo clique
        ...
        geo = _load_geojson()
        self.poly_dict = _build_poly_dict(geo)   # {name: [[ring], ...]}

        # Pré-renderiza superfície do mapa (estática)
        self.map_surf = self._build_map_surface()

    # ── Converte coordenada para pixel na área do mapa ──
    ...
    # ── Superfície estática do mapa (polígonos vetoriais) ──
    def _build_map_surface(self):
        surf = pygame.Surface((self.MAP_W, self.MAP_H))
        surf.fill(C["map_bg"])

        # Cores alternadas por estado — variação sutil para diferenciar vizinhos
    ...
    # ── Desenha mapa com grafo por cima ─────────────────
    def draw_map(self):
        self.anim_t += 0.04

        pygame.draw.rect(self.screen, C["map_bg"],
                         pygame.Rect(self.MAP_X, 0, self.MAP_W, self.MAP_H))
        ...
        # Hover highlight sobre o polígono do estado
        if self.hover_state and self.hover_state in self.poly_dict:
            for ring in self.poly_dict[self.hover_state]:
                pts = [(p[0] + self.MAP_X, p[1])
                       for p in [self._gp(lon, lat) for lon, lat in ring]]
                if len(pts) >= 3:
        ...
        for aresta in ARESTAS:
            ...
            if de not in ESTADOS_GEO or para not in ESTADOS_GEO:
                continue
            a = self.state_px(de)
        ...
        # Tooltip da aresta clicada (fixo, por cima de tudo)
        ...
        # Tooltip de hover (só se não há aresta clicada)
        ...
        for nome, info in ESTADOS_GEO.items():
            ...
            uf  = info["uf"]
            tc  = ((220,255,220) if is_orig else (255,160,160) if is_dest
                   else C["text_accent"] if in_path else C["label_uf"])
        ...
        # ── Tooltip ──────────────────────────────
        if self.hover_state and self.hover_state in ESTADOS_GEO:
    ...
    def draw_panel(self):
        ...
        pygame.draw.line(self.screen, C["panel_border"],
                         (self.PANEL_W, 0), (self.PANEL_W, self.H), 1)
        ...
        self._txt(self.f_small, "⇅  Inverter rota", C["text_muted"],
                  self.PANEL_W//2, y+8, "midtop")
        y += 38
        ...
        self._txt(self.f_btn, "▶  Calcular Rota Mais Curta",
                  C["btn_text"], self.PANEL_W//2, y+12, "midtop")
        y += 52

        pygame.draw.line(self.screen, C["panel_border"],
                         (18, y), (self.PANEL_W-18, y), 1)
        y += 14
        ...
        if not self.caminho:
            self._txt(self.f_small, "Selecione dois estados",
                      C["text_light"], self.PANEL_W//2, y+6,  "midtop")
            self._txt(self.f_small, "ou clique no mapa",
                      C["text_light"], self.PANEL_W//2, y+22, "midtop")
            return
        ...
        for i, estado in enumerate(self.caminho):
            ...
            if ey + STEP_H < 0 or ey > area_h:
                continue
            is_orig = i == 0
            is_dest = i == len(self.caminho)-1
            dot_col = (C["node_origin"] if is_orig
                       else C["node_dest"] if is_dest else C["step_mid"])
            if i < len(self.caminho)-1:
                pygame.draw.line(clip, C["panel_border"],
                                 (30, ey+28), (30, ey+STEP_H+4), 1)
            pygame.draw.circle(clip, dot_col, (30, ey+16), 6)
            if is_orig or is_dest:
                pygame.draw.circle(clip, (220,240,255), (30, ey+16), 6, 2)
            nc = ((180,255,210) if is_orig else (255,160,160) if is_dest
                  else C["text_main"])
        ...
        if self.scroll_max > 0:
            ...
            pygame.draw.rect(self.screen, C["panel_border"],
                             pygame.Rect(self.PANEL_W-5, sb_y, 3, sb_h), border_radius=2)
    ...
    def _draw_edge_tooltip(self, de, para, km, rod, mx, my):
        """Desenha tooltip flutuante de uma aresta."""
        lines = [
            rod,
            f"{de}  →  {para}",
            f"{km:,} km".replace(",", "."),
        ...
        # Posiciona ao lado do cursor sem sair da tela
        tx = mx + 14
        ty = my - lh // 2
        if tx + lw > self.W - 4:
            tx = mx - lw - 10
    ...
    def handle_event(self, ev):
        ...
        if ev.type == pygame.MOUSEBUTTONDOWN and ev.button == 1:
            if mx > self.MAP_X:
                ...
                # Clique em aresta? (só se não clicou em nó)
                if not hit_node:
                    THRESH = 7
                    best_d = THRESH + 1
                    best_e = None
                    for aresta in ARESTAS:
                        ...
                        if d < best_d:
                            best_d = d
                            best_e = aresta
                    # Toggle: clica de novo na mesma aresta para desfixar
                    if best_e and best_e == self.clicked_edge:
                        self.clicked_edge = None
                    elif best_e:
                        self.clicked_edge = best_e
                    else:
                        self.clicked_edge = None

            if self.swap_rect.collidepoint(mx, my):
                self.dd_orig.selected, self.dd_dest.selected = (
                    self.dd_dest.selected, self.dd_orig.selected)
                self.origem  = self.dd_orig.selected
                self.destino = self.dd_dest.selected
                if self.origem and self.destino:
                    self._calcular()
...
class Dropdown:
    ...
    def draw(self, surface):
        ...
        surface.blit(self.fs.render("▲" if self.open else "▼", True, C["accent"]),
                     (self.x+self.w-18, self.y+12))
    ...
    def draw_dropdown(self, surface):
        ...
        for i, opt in enumerate(vis):
            ...
            if is_sel:
                pygame.draw.rect(surface, C["accent"], row, border_radius=4)
            elif is_hover:
                pygame.draw.rect(surface, C["select_hover"], row, border_radius=4)
