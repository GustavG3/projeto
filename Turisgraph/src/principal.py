...
ARESTAS = [
    ...
    ("Roraima",           "Amapá",               1200, "BR-156/174"),
    ("Amazonas",          "Acre",                550,  "BR-317"),
    ("Amazonas",          "Pará",                530,  "BR-319/230"),
    ("Amazonas",          "Tocantins",           700,  "BR-230"),
    ("Amazonas",          "Mato Grosso",         750,  "BR-230/163"),
    ("Acre",              "Rondônia",            550,  "BR-364"),
    ("Rondônia",          "Mato Grosso",         900,  "BR-364"),
    ("Mato Grosso",       "Tocantins",           600,  "BR-158"),
    ("Mato Grosso",       "Goiás",               350,  "BR-158/070"),
    ("Mato Grosso",       "Mato Grosso do Sul",  500,  "BR-163"),
    ("Mato Grosso do Sul","São Paulo",           500,  "BR-262/060"),
    ("Mato Grosso do Sul","Paraná",              700,  "BR-163/277"),
    ("Paraná",            "São Paulo",           400,  "BR-376/116"),
    ("Paraná",            "Santa Catarina",      400,  "BR-116/376"),
    ("Santa Catarina",    "Rio Grande do Sul",   320,  "BR-116/101"),
    ("Goiás",             "Minas Gerais",        200,  "BR-050/040"),
    ("Goiás",             "São Paulo",           300,  "BR-153/050"),
    ("Minas Gerais",      "Espírito Santo",      200,  "BR-262/101"),
    ("Minas Gerais",      "Rio de Janeiro",      300,  "BR-040/116"),
    ("Minas Gerais",      "Bahia",               300,  "BR-116/251"),
    ("Rio de Janeiro",    "Espírito Santo",      100,  "BR-101"),
    ("Rio de Janeiro",    "Bahia",               520,  "BR-101/116"),
    ("Bahia",             "Sergipe",             350,  "BR-116/101"),
    ("Bahia",             "Alagoas",             320,  "BR-101/110"),
    ("Bahia",             "Pernambuco",          400,  "BR-116/428"),
    ("Bahia",             "Piauí",               400,  "BR-116/020"),
    ("Bahia",             "Tocantins",           300,  "BR-242/020"),
    ("Tocantins",         "Pará",                500,  "BR-153/226"),
    ("Tocantins",         "Maranhão",            750,  "BR-010/226"),
    ("Maranhão",          "Piauí",               400,  "BR-316/135"),
    ("Maranhão",          "Pará",                1200, "BR-010/316"),
    ("Piauí",             "Ceará",               400,  "BR-020/316"),
    ("Ceará",             "Rio Grande do Norte", 130,  "BR-304"),
    ("Ceará",             "Paraíba",             400,  "BR-230/116"),
    ("Paraíba",           "Pernambuco",          400,  "BR-230/101"),
    ("Pernambuco",        "Alagoas",             320,  "BR-101/424"),
    ("Amapá",             "Pará",                450,  "BR-156/010"),
]
...
class TurisGraphApp:
    ...
    def draw_panel(self):
        ...
        self._txt(self.f_small, "Dijkstra · Rodovias · 26 estados", C["text_muted"], 58, 36)
