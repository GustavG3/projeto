...
> Grafo com 27 vértices (estados brasileiros) e  arestas (rodovias federais), com pesos representando distâncias em km. O diagrama exibe as conexões reais entre estados vizinhos, respeitando a topologia do mapa do Brasil. A rota destacada em verde exemplifica o caminho mínimo calculado pelo algoritmo de Dijkstra entre dois estados.
